...
const READ_CASES: Case[] = [
  ...
  // --- university --------------------------------------------------------
  // Brightspace is gone for good, so the only acceptable read here is the
  // manually-entered data via get_university_deadlines/get_grades — there
  // is no get_brightspace_courses to fall back to any more.
  { id: "U1", group: "university", prompt: "What assignments are coming up?",
    anyOf: ["get_university_deadlines"] },
